  ...
  function injectPanel() {
    ...
    panel.innerHTML = `
      ...
      <div class="command-content">
        <h2 class="command-title">A5 Browser Automation</h2>
        ...
        <button id="advancedSettingsBtn" class="advanced-settings-btn">
          <span class="gear-icon">⚙️</span> Advanced Settings
        </button>
        
        <div id="advancedSettingsContainer" class="advanced-settings-container">
          <p class="advanced-settings-text">
            Add context that will be included with all commands.<br>
            This helps the agent understand your preferences and overcome obstacles.
          </p>
          <textarea id="advancedSettingsTextarea" class="advanced-settings-textarea" placeholder="Enter context to include with all commands..."></textarea>
    ...
    function loadAdvancedSettings() {
      chrome.storage.local.get(["agenticAdvancedContext"]).then((result) => {
    ...
    function saveAdvancedSettings() {
      ...
      chrome.storage.local.set({ agenticAdvancedContext: contextValue }).then(() => {
        // On successful save
        setTimeout(() => {
    ...
    runButton.addEventListener("click", async () => {
      ...
      try {
        ...
        chrome.storage.local.get(["agenticAdvancedContext"]).then(async (result) => {
          ...
          console.error("Error retrieving advanced context:", err);
          feedbackMessage.textContent = "Failed to retrieve context. Please try again.";
        });
      } catch (error) {
